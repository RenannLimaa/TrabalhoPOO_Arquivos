...
public class Crud {
    ...
    public boolean createStudent(Disciplina disciplina, Aluno aluno){
        ...
        try {
            FileWriter fWriter = new FileWriter("Data/"+disciplina.getNome()+"/"+disciplina.getNome() + ".txt", true);
    ...
    public void readFile(Disciplina disciplina){
        ...
        try{
            fReader = new FileReader("Data/"+disciplina.getNome()+"/"+disciplina.getNome()+".txt");
